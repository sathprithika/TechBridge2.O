...
const MenuPage = ({ page }) => {
  ...
  return (
    <div className="flex flex-row h-screen w-full bg-gray-100">
      <div className="h-screen w-1/6 bg-purple-600 shadow-md">
        <div className="flex flex-row justify-center r w-full p-3 border-b border-gray-100">
          <div className="font-serif text-2xl text-white tracking-widest  py-1">Tech Bridge</div>
        </div>
        <div className="flex flex-col">
          <Link
            to="/chat"
            className={`w-full flex flex-row py-4 text-white text-md ${
              location.pathname === "/chat" ? "bg-purple-700" : "hover:bg-purple-700"
            }`}>
          ...
          <Link
            to="/dashboard"
            className={`w-full flex flex-row py-4 text-white text-md ${
              location.pathname === "/dashboard" ? "bg-purple-700" : "hover:bg-purple-700"
            }`}>
          ...
          <Link
            ...
            className={`w-full flex flex-row py-4 text-white text-lg ${
              location.pathname === "/editprofile" ? "bg-purple-700" : "hover:bg-purple-700"
            } mb-10`}>
      ...
      <div className="flex flex-col w-5/6 pb-5">
        <div className="flex flex-row-reverse w-full bg-purple-600 p-3 shadow-md">
